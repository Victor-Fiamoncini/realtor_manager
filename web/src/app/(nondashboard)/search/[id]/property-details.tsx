  ...
  return (
    <div className="mb-6">
          ...
          {property.amenities.map((amenity: AmenityEnum) => {
            ...
            return (
              <div key={amenity} className="flex flex-col items-center rounded-xl border px-4 py-8">
                ...
                <span className="text-center text-sm text-gray-700">{formatEnumString(amenity)}</span>
              </div>
            )
          })}
        </div>
      ...
      <div className="mt-12 mb-16">
        <h3 className="text-primary-800 dark:text-primary-100 text-xl font-semibold">Highlights</h3>
        ...
        <div className="mt-4 grid w-full grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {property.highlights.map((highlight: HighlightEnum) => {
            ...
            return (
              <div key={highlight} className="flex flex-col items-center rounded-xl border px-4 py-8">
      ...
      <div>
        <h3 className="text-primary-800 dark:text-primary-100 mb-5 text-xl font-semibold">Fees and Policies</h3>
        ...
        <Tabs defaultValue="required-fees" className="mt-8">
          ...
          <TabsContent value="pets">
            <p className="mt-5 mb-2 font-semibold">Pets are {property.isPetsAllowed ? 'allowed' : 'not allowed'}</p>
          </TabsContent>
