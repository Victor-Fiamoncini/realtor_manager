...
const AppApplicationCard = ({ application, userType, children }: ApplicationCardProps) => {
        ...
        <div className="flex w-full flex-col justify-between gap-3 py-2 lg:h-48 lg:basis-2/12 lg:gap-0">
          <div>
            <div className="flex items-center justify-between">
              ...
              <span className={`px-2 py-1 ${statusColor} rounded-full text-sm text-white`}>{application.status}</span>
            </div>
...
export default AppApplicationCard
