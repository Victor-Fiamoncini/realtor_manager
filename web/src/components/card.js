...
const Card = ({ property, isFavorite, onFavoriteToggle, showFavoriteButton = true, propertyLink }) => {
      ...
      <div className="relative">
        ...
        <div className="absolute bottom-4 left-4 flex gap-2">
          {property.isPetsAllowed && (
            <span className="rounded-full bg-white/80 px-2 py-1 text-xs font-semibold text-black">Pets Allowed</span>
          )}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <p className="mb-3 text-lg font-bold">
            ${property.pricePerMonth.toFixed(0)} <span className="text-base font-normal text-gray-600"> /month</span>
          </p>
        </div>
